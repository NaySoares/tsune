function RandomReplyBravo() {
  const replyBravo = [
    ...
    {
      id: 2,
      reply: "Deve sair segunda-feira, isso se o Bravo não estiver no cabeleireiro.",
    },
    {
      id: 3,
      reply: "Deve sair segunda-feira, isso se o Bravo não estiver cuidando da sua fortuna de 99% do PIB do Brasil.",
    },
    {
      id: 4,
